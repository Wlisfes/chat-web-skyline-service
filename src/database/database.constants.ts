import {
    TbSkylineChunk,
    TbSkylineChunkModuleEntity,
    TbSkylineDatetaskLog,
...
export const SKYLINE_MYSQL_ENTITIES = [TbSkylineChunk, TbSkylineChunkModuleEntity, TbSkylineDatetaskSystem, TbSkylineDatetaskLog]
