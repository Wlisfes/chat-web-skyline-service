...
import { FinanceFeignClient, FeignModule } from '@wlisfes/chat-web-base-schema/feign'
...
@Module({
    imports: [TypeOrmModule.forFeature([TbSkylineDatetaskSystem]), FeignModule.register([FinanceFeignClient])],
